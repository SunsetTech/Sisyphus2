...
---@class Sisyphus2.Compiler.Objects.Nested.PEG.Immediate : Sisyphus2.Compiler.Objects.Nested.PEG.Base
---@field InnerPattern Sisyphus2.Compiler.Objects.Nested.PEG.Base
---@field Function function
local Immediate = OOP.Declarator.Shortcuts(
	"Sisyphus2.Compiler.Objects.Nested.PEG.Immediate", {
		require"Sisyphus2.Compiler.Objects.Nested.PEG.Base"
	}
)

---@param Instance Sisyphus2.Compiler.Objects.Nested.PEG.Immediate
